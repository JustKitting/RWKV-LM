...
#
python train.py --wandb "Test" --proj_dir $PROJ_DIR \
 --data_file "mnt/TrainingData/Training/EleutherAI_ThePile_v1/pile/train" --data_type "binidx" --vocab_size 65536 --my_testing $MODEL_TYPE \
